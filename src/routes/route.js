...
// if a given path is not matching any of our routes    // it will return this error  
//* way-2 ,  //** way-1 in index.js ln: 23
router.all("/*", (req, res) => { res.status(404).send( { status: false, message: "/ Given Path Is Unidentified /" } );  });
